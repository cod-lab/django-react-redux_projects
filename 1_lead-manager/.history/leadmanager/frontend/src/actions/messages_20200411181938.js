...
// CREATE MESSAGE
export const createMessage = msg => {                       // 'createMessage' will have parameter 'msg' which will hold the data(object)(apt. msg) when this 'action' is called from 'action'(leadmanager/frontend/src/actions/leads.js)
    return {
