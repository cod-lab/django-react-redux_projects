...
// CREATE MESSAGE
export const createMessage = msg => {                       // 'createMessage' will have parameter 'msg' which will hold the apt. msg when this 'action' called from 'action'(leadmanager/frontend/src/actions/leads.js)
    return {
