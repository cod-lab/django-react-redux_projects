...
export const login = (username, password) => dispatch => {                  // sending user credentials to server(django) & reducer
        ...
        // Request Body
        const body = JSON.stringify({ username, password });                // convert JavaScript object into string and passing this along with 'post' request

        axios.post('api/auth/login', body, config)
        // send 'post' request to 'api/auth/login' along with 'body' (holding credentials) & 'config'(cyrrently empty)
