...
// CREATE MESSAGE
export const createMessage = msg => {                       // variable 'createMessage' has a parameter 'msg' which will hold the data(object)(apt. msg) when this variable is called from 'action'(leadmanager/frontend/src/actions/leads.js)
    return {
