...
export const getLeads = () => dispatch => {
    axios.get('/api/leads/')                                // send get request to '/api/leads/', get leads from the server(django)
        .then(res => {
            dispatch({
...
export const deleteLead = (id) => dispatch => {
    axios.delete(`/api/leads/${id}/`)                       // send delete request to '/api/leads/', now lead will be deleted from the server(django) too
        .then(res => {
            dispatch({
...
export const addLead = (lead) => dispatch => {
    axios.post('/api/leads/', lead)                         // send post request to '/api/leads/', adding a 'lead' into server(django)
        .then(res => {
            dispatch({
                type: ADD_LEAD,
                payload: res.data
