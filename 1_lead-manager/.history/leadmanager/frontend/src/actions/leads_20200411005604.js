    ...
    axios.post('/api/leads/', lead)                         // send 'post' request to '/api/leads/' to add a 'lead' into the server(django) and add it here only
        ...
        .catch(err => {
            const getErrors = {
                ...
                // receive msg of err (generated from server) from 'component'(leadmanager/frontend/src/reducers/errors.js)
                status: err.response.status
                // receive status of err (generated from server) from 'component'(leadmanager/frontend/src/reducers/errors.js)
            };
            dispatch({
