...
export const createMessage = msg => {                       // 'createMessage' will take parameter 'msg'
    ...
    // return(dispatch)(send) 'type' 'createMessage' to 'reducer'(leadmanager/frontend/src/reducers/messages.js) to send all the leads and,
    // 'reducer' sends it to component(leadmanger/frontend/src/components/leads/Alerts.js) to display the msg
        type: CREATE_MESSAGE,
