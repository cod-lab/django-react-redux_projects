...
// CREATE MESSAGE
export const createMessage = msg => {                       // 'createMessage' has the parameter 'msg' which will hold the data(object)(apt. msg) when 'createMessage' is called from 'action'(leadmanager/frontend/src/actions/leads.js)
    return {
