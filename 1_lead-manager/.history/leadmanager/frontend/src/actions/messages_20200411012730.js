...
// CREATE MESSAGE
export const createMessage = msg1 => {                       // 'createMessage' will have parameter 'msg' which will hold the apt. msg when this 'action' is called from 'action'(leadmanager/frontend/src/actions/leads.js)
    return {
