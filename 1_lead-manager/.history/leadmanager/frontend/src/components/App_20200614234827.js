...
class App extends Component {
    ...
    componentDidMount(){                                            // it fires off whenever the component is mounted the main app i.e. when our app loads
        store.dispatch(LoadUser());                                 // calling dispatch directly from the store.js and passing variable 'LoadUser' to call variable 'LoadUser'     dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddkkkdfkdfldfkldf
    }
