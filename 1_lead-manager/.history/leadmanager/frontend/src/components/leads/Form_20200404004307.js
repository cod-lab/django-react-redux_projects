...
// 'addLead' is giving the 'lead' from 'reducer'(leadmanager/frontend/src/reducers/leads.js) which is getting it from 'action'(leadmanger/frontend/src/actions/leads.js)