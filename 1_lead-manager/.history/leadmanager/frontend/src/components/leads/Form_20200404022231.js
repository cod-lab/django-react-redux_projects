        ...
        return (
            <div className="card card-body mt-4 mb-4">
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <button onClick={this.props.addLead.bind(this, lead.id)} className="btn btn-primary" type="submit">Submit</button>
                        {/* 'this.props.addLead()' will give access to 'prop' 'addLead' created above */}
                        {/* add 'lead' to frontend */}
                        {/* store the added 'lead' data into 'prop' 'addLead' when user adds that 'lead' */}                        
                    </div>
                </form>
            </div>
        )
...
// sending 'prop' 'addLead' to action('leadmanager/frontend/src/actions/leads.js')
