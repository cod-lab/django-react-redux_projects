...
export class Leads extends Component {
    ...
    static propTypes = { leads: PropTypes.array.isRequired };               // getting 'prop' 'leads' from variable 'MapStateToProps' written below
...
// 'leads:' = 'prop' = new variable for 'prop', all 'states' mapped into this 'prop'
