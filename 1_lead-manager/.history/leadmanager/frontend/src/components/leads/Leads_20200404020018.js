                    ...
                    <tbody>
                        { this.props.leads.map(lead => (
                            <tr key={lead.id}>
                                ...
                                {/* storing deleted 'lead' data into 'prop' 'deleteLead' when user deletes that 'lead'*/}
                            </tr>
                        ))}
                    </tbody>
                </table>
...
// sending 'props' 'getLead', 'deleteLead' to action('leadmanager/frontend/src/actions/leads.js')
