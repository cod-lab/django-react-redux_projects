                    ...
                    <tbody>
                        { this.props.leads.map(lead => (
                            <tr key={lead.id}>
                                ...
                                <td>{lead.email}</td>
                                <td>{lead.message}</td>
                                <td><button onlick={this.props.deleteLead.bind(this, lead.id)} className="btn btn-danger btn-sm">DELETE</button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
...
// 'delLeads' will give access to 'this.props.deleteLead()'
