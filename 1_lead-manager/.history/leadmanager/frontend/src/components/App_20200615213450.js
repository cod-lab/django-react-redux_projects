...
import { loadUser } from '../actions/auth.js';                      // importing to call 'LoadUser' almost all the time
...
class App extends Component {
    ...
    componentDidMount(){                                            // it fires off whenever the component is mounted the main app i.e. when our app loads
        store.dispatch(loadUser());                                 // calling dispatch directly from the store.js and passing variable 'loadUser' to call variable 'loadUser'
        // calling variable 'loadUser' from 'leadmanger/frontend/src/actions/auth.js'
        // user come down from the 'reducer' into the 'component'
        // 'loadUser' herer is getting the 'user' from 'reducer'(leadmanager/frontend/src/reducers/auth.js) which is getting it from 'action'(leadmanger/frontend/src/actions/auth.js)
    }
