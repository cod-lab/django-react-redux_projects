                        ...
                        <Fragment>
                            ...
                            <div className="container">
                                <Switch>                                {/* surround all the routes with the switch */}
                                    ...
                                    <Route exact path="/" component={Register} />      {/* component 'Dashboard' to display main content(leads,form) of site on webpg */}
                                    <Route exact path="/" component={Login} />      {/* component 'Dashboard' to display main content(leads,form) of site on webpg */}
                                </Switch>
                            </div>
                        </Fragment>
                    </Router>
