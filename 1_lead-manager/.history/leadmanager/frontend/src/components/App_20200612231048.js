                        ...
                        <Fragment>
                            ...
                            <div className="container">
                                <Switch>                                {/* surround all the routes with the switch */}
                                    ...
                                    <Route exact path="/register" component={Register} />      {/* component 'Dashboard' to display main content(leads,form) of site on webpg */}
                                    <Route exact path="/login" component={Login} />      {/* component 'Dashboard' to display main content(leads,form) of site on webpg */}
                                </Switch>
                            </div>
                        </Fragment>
                    </Router>
