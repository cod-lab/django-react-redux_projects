            ...
            <div classNam="col-md-6 m-auto">
                <div classNam="card card-body mt-5">
                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        {/* 'Link' will replace the text succeeding the default or home url with the given text
                                will add the given string to url by replacing the string succeeding default or home url and run the resultant url*/}
                    </form>
                </div>
            </div>
        )
