...
export class Register extends Component {
    ...
    onSubmit = e => {
        ...
        if (password !== password2)                                                 // confirmation password must match
            ...
            // passing user enetered details to 'action'(leadmanager/frontend/src/actions/auth.js) to send to server(django) to register
        }
    };
...
export default connect(mapStateToProps, { register, createMessage })(Register);
    ...
    // cls 'Register' is a 'component' here wrapped with redux store's state(leadmanager/frontend/src/reducers/auth.js) & 'actions' 'register' & 'createMessage' thru 'connect' using '()'
    // cls 'Register' is a 'component' here wrapped thru 'connect' using '()'
