...
import { register } from '../../actions/auth';                                         // we call 'login' when 'component' mounts (basically when calling fn 'componentDidMount')
import { createMessage } from '../../actions/messages';                                // we call 'login' when 'component' mounts (basically when calling fn 'componentDidMount')
