...
export class Register extends Component {
    ...
    render() {
        const { username, email, password, password2 } = this.state;            // getting data from state above
        return (
            <div classNam="col-md-6 m-auto">
                <div classNam="card card-body mt-5">
                    ...
                    <div className="form-group">
                        <label>Email</label>
                        <input className="form-control" type="email" name="name" onChange={this.onChange} value={email} />
                    </div>
                    <div className="form-group">
