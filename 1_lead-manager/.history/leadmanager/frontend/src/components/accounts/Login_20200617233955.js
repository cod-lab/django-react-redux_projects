...
// this will map state to props of this component
    // 'isAuthenticated:' = 'prop' = declared above, will get the statte(value) from 'reducer'(leadmanager/frontend/src/reducers/auth.js)    current 'state' will be mapped into this 'prop'
...
// isAuthenticated = prop created above
// state.isAuthenticated = reducer imported from 'leadmanger/frontend/src/reducers/index.js'
