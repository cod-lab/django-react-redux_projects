...
import { register } from '../../actions/auth';                                      // we call 'register' when 'component' mounts (basically when calling fn 'componentDidMount')
import { createMessage } from '../../actions/messages';                             // we call 'createMessage' when 'component' mounts (basically when calling fn 'componentDidMount')
...
export class Register extends Component {
    ...
    onSubmit = e => {
        ...
        if (password !== password2)
            this.props.createMessage({ passNotMatch: "Passwords do not match" });
        else {
