...
export class Register extends Component {
    ...
    onSubmit = e => {
        ...
        if (password !== password2)                                                 // confirmation password must match
            ...
            const newUser = { username, email, password };                          // passing user enetered details to 'action'(leadmanager/frontend/src/actions/auth.js) to send to server(django) to register
