    ...
    render() {
        ...
        const authLinks = (
            <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
                <li className="nav-item"><button className="nav-link btn btn-info btn-sm text-light" onClick={() => { this.props.logout; window.location.reload(false); }}>Logout</button></li>
            </ul>
        );
