...
// sending alerts('error','message') to 'actions' (leadmanager/frontend/src/actions/leads.js) & (leadmanager/frontend/src/actions/messages.js) 
//to delete 'lead' from server(django) too
