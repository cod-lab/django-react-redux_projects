...
export class Header extends Component {
    ...
    fn2() { const fn3 = (this.props.logout); }
    ...
    render() {
        ...
        const authLinks = (
            <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
                <li className="nav-item"><button className="nav-link btn btn-info btn-sm text-light" onClick={() => {this.fn2();this.fn3();}}>Logout</button></li>
            </ul>
        );
