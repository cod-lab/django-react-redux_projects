...
export class Header extends Component {
    ...
    render() {
        const { isAuthenticated, user } = this.props.auth;                          // 'isAuthenticated' is getting value from current state
...
// 
    // connecting/sending 'prop' 'logout' to 'action'(leadmanager/frontend/src/actions/auth.js) to remove token from server(django) and 'local storage'
