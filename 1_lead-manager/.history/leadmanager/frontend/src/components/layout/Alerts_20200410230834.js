    ...
    componentDidUpdate(prevProps) {
        ...
        if (message !== prevProps.message) {
            if (message.deleteLead)
                ...
                // it will display the value(string)(msg) of key 'deleteLead' created in action(leadmanager/frontend/src/actions/leads.js)
            if (message.addLead)
                alert.success(message.addLead);
                // it will display the value(string)(msg) of key 'addLead' created in action(leadmanager/frontend/src/actions/leads.js)
        }
