...
export class Alerts extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (error !== prevProps.error) {
            if (error.msg.name) // if name err prompted on srvr
            ...
            if (error.msg.email) // if email err prompted on srvr
                ...
                // ${} = this makes/add variable while printing
                // .join() = convert array to string
            if (error.msg.message) // if message err prompted on srvr
...
// sending alerts to 'actions'('leadmanager/frontend/src/actions/leads.js') & (leadmanager/frontend/src/actions/messages.js) to delete 'lead' from server(django) too
// cls 'Alerts' is the 'component' which is being exported
// 'mapStateToProps' is giving the 'states' to 'leadmanger/frontend/src/reducers/index.js'
