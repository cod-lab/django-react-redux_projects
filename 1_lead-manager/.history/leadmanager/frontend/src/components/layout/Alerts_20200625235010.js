    ...
    componentDidUpdate(prevProps) {
        ...
        if (error !== prevProps.error) {
            ...
            if (error.msg.non_field_errors) // if err prompted from srvr
                ...
                // .join() = convert array to string
                // this err is prompted at the time of registration if 'passwords mismatch'
            if (error.msg.username) // if err prompted from srvr
                ...
                // .join() = convert array to string
                // this err is prompted at the time of registration if 'user already exist'
        }
        ...
        if (message !== prevProps.message) {
            ...
            if (message.passNotMatch)
                ...
                // it will display the value(string)(msg) of property 'passNotMatch' created in 'action'(leadmanager/frontend/src/actions/leads.js)
                // it'll catch and display msg for event occured in 'action'(leadmanager/frontend/src/actions/leads.js)
        }
