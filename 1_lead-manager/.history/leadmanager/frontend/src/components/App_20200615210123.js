...
class App extends Component {
    ...
    componentDidMount(){                                            // it fires off whenever the component is mounted the main app i.e. when our app loads
        ...
        // 'loadUser' is getting the 'user' from 'reducer'(leadmanager/frontend/src/reducers/auth.js) which is getting it from 'action'(leadmanger/frontend/src/actions/leads.js)
    }
