...
class App extends Component {
    ...
    componentDidMount(){                                            // it fires off whenever the component is mounted the main app i.e. when our app loads
        ...
        // 'getLeads' is getting the 'leads' from 'reducer'(leadmanager/frontend/src/reducers/leads.js) which is getting it from 'action'(leadmanger/frontend/src/actions/leads.js)
    }
