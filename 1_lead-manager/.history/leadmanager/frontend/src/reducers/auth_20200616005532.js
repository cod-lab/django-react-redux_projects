...
const initialState = {
    ...
    isLoading: false,                                               
    // when it'll fire off we gonna hv 'action' 'isLoading' which will fire off in between trying to load the user and actually (load the user) making the request and getting the response back and then it'll change back to false
    user: null
};
