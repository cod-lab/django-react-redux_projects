import { GET_LEADS, DELETE_LEAD, ADD_LEAD, GET_ERRORS } from '../actions/types.js';        // get the leads from backend and display them here in the leads list component
    ...
    switch (action.type) {
        ...
        case DELETE_LEAD:
            return {                        // send everything below to 'component'(leadmanager/frontend/src/components/leads/Leads.js)
                ...
                // earlier in 'postman' for deleting leads we sent the 'id' as the 'payload', so we do the same here
        ...
        case ADD_LEAD:
            return {                        // send everything below to 'component'(leadmanager/frontend/src/components/leads/Leads.js)
                ...
                leads: [
                    ...
                    action.payload          // added lead is stored in 'payload' in 'action'(leadmanager/frontend/src/actions/leads.js) and sent here
                ]
            };
        default:
            return state;
