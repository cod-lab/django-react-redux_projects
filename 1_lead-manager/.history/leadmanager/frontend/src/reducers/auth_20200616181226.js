import { USER_LOADING, USER_LOADED, AUTH_ERROR, LOGIN_SUCCESS, LOGIN_FAIL } from '../actions/types.js';
...
export default function(state = initialState, action) {
    switch (action.type) {
        ...
        case LOGIN_SUCCESS:
            localStorage.setItem('token',action.payload.token);      // add any token from local storage if there's one
            return {
                ...state,
                ...action.payload,
