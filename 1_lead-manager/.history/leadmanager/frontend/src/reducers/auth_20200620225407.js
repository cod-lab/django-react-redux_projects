import { USER_LOADING, USER_LOADED, AUTH_ERROR, LOGIN_SUCCESS, LOGIN_FAIL, LOGOUT_SUCCESS } from '../actions/types.js';

const initialState = {
    token: localStorage.getItem('token'),                       // the token will be stored in local storage
    isAuthenticated: false,                                      // once user login or user is loaded, it'll turn to true and token will be stored in local storage
    isLoading: false,
