const initilState {
    ...
    isLoading: false,                                               
    // when it'll fire off we're gonna hv 'action' 'isLoading' which will fire off in between trying to load the user and actually (load the user) making the request and getting the response back
    user: null
}
