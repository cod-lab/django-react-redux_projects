...
class RegisterSerializer(serializers.ModelSerializer):      # we used 'ModelSerializer' to create model
    ...
    # 'validated_data' is a default property that holds the dict (bydefault) containg user data which is sent by 'api' 'RegisterAPI' stored in file 'leadmanager/accounts/api.py'
