...
class LoginAPI(generics.GenericAPIView):
    ...
    # when we make a request to login user on web, all the data(username,pass) we send from web will be here
        ...
        # it calls 'LoginSerializer' from 'serializer'(leadmanager/accounts/serializers.py) & executes it and,
        # validated_data = an inbuilt property that holds the dict (bydefault) containg user data(unm,pass) which is sent by 'api' 'LoginAPI' stored in file 'leadmanager/accounts/api.py'
