...
class LoginAPI(generics.GenericAPIView):
    ...
    # when we make a request to login user on web, all the data(username,pass) we send from web will be here
        ...
        # fn 'validate' in 'serializer' 'LoginSerializer' in file 'leadmanager/accounts/serializers.py' executes & returns here the above passed user data(unm,pass) in form of user object
        # Now this data is 
